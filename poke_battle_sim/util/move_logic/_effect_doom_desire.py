...
def _effect_doom_desire(attacker: pk.Pokemon, defender: pk.Pokemon,
    ...
    if defender.is_alive and not t.dd_count:
        ...
        t.dd_dmg = _calculate_damage(attacker, defender, battlefield,
            battle, move_data, crit_chance=0, skip_dmg=True)
        t.dd_count = 3
