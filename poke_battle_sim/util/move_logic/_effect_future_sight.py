...
def _effect_future_sight(attacker: pk.Pokemon, defender: pk.Pokemon,
    ...
    if defender.is_alive and not t.fs_count:
        ...
        t.fs_dmg = _calculate_damage(attacker, defender, battlefield,
            battle, move_data, crit_chance=-4, skip_dmg=True)
        t.fs_count = 3
