...
def _effect_guard_swap(attacker: pk.Pokemon, defender: pk.Pokemon,
    ...
    if defender.is_alive:
        attacker.stat_stages[gs.DEF], defender.stat_stages[gs.DEF
            ] = defender.stat_stages[gs.DEF], attacker.stat_stages[gs.DEF]
        attacker.stat_stages[gs.SP_DEF], defender.stat_stages[gs.SP_DEF
            ] = defender.stat_stages[gs.SP_DEF], attacker.stat_stages[gs.SP_DEF
            ]
