...
def _effect_imprison(attacker: pk.Pokemon, defender: pk.Pokemon,
    ...
    t = defender.trainer
    if not t.imprisoned_poke and any([(move.name in a_moves) for poke in t.
        poke_list for move in poke.moves]):
