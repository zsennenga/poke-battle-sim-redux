...
def _effect_fury_cutter(attacker: pk.Pokemon, defender: pk.Pokemon,
    battlefield: bf.Battlefield, battle: bt.Battle, move_data: Move,
    is_first: bool, cc_ib: list) ->bool:
    if (attacker.last_move and attacker.last_move is attacker.
        last_successful_move and attacker.last_move.name == move_data.name):
