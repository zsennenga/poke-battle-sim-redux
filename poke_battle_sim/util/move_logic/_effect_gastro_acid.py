...
def _effect_gastro_acid(attacker: pk.Pokemon, defender: pk.Pokemon,
                        battlefield: bf.Battlefield, battle: bt.Battle, move_data: Move,
                        is_first: bool, cc_ib: list) -> bool:
    if defender.is_alive and not defender.has_ability(Ability.MULTITYPE) and not defender.ability_suppressed:
