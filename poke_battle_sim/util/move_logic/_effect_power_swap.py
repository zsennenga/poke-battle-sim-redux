...
def _effect_power_swap(attacker: pk.Pokemon, defender: pk.Pokemon,
    ...
    if defender.is_alive:
        attacker.stat_stages[gs.ATK], defender.stat_stages[gs.ATK
            ] = defender.stat_stages[gs.ATK], attacker.stat_stages[gs.ATK]
        attacker.stat_stages[gs.SP_ATK], defender.stat_stages[gs.SP_ATK
            ] = defender.stat_stages[gs.SP_ATK], attacker.stat_stages[gs.SP_ATK
            ]
