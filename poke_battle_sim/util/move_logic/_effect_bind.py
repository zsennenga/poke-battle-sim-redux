...
def _effect_bind(attacker: pk.Pokemon, defender: pk.Pokemon, battlefield:
    ...
    if (defender.is_alive and dmg and not defender.substitute and not
        ...
        if move_data.ef_stat == gs.BIND:
            ...
            battle.add_text(attacker.nickname + ' clamped ' + defender.
                nickname + '!')
            ...
            battle.add_text(defender.nickname +
                ' became trapped by swirling magma!')
    return True
